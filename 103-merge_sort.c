 ...
 * @subarr: Integer subarray to sort.
...
/**
 * merge_sort_recursive - A function to do the the merge sort algorithm via recursion.
...
/**
 * merge_sort - A function to sort array of integers.
 * @array: Integer array.
 * @size: Array size.
